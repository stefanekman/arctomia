+-------------------------------------–––––––––––+
| This script performs a nonparametric bootstrap |
| across trees and alignment uncertainty         |
+------------------------------------------------+
...
for (i in 1:1000) {
	...
	system2("/Applications/iqtree-2.1.3-MacOSX/bin/iqtree2", args="-s concatenated.fasta --bonly 1 -m GTR+F+I+G --prefix tmp__", stdout=F)
